...
void BlendedTerrainWindow3::OnIdle()
{
    ...
    auto clearColor = mEngine->GetClearColor();
    ImGui::ColorEdit3("Background color", &clearColor[0], ImGuiColorEditFlags_NoInputs);
